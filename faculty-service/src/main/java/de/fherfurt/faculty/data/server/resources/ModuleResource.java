...
/**
 * Describes all endpoints of functionalities of module operations the server provides
 */
public class ModuleResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateDescriptionDocument(
            @PathParam( "module-id" ) long moduleId,
            @QueryParam("description-document") String descriptionDocument) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response addProfessorToModule(
            @PathParam( "module-id" ) long moduleId,
            @QueryParam("professor-name") String professorName) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response removeProfessorFromModule(
            @PathParam( "module-id" ) long moduleId,
            @QueryParam("professor-name") String professorId){
